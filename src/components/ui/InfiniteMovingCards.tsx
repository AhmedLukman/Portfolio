  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] hover:shadow hover:shadow-pink-500/50 hover:shadow-sm max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-96"
            style={{
              background:
            ...
            <blockquote className="flex flex-col h-full ">
              ...
              <div className="relative z-20 pt-6 flex gap-3 flex-row mt-auto items-center">
                ...
                <span className="flex flex-col">
                  ...
                  <span className=" text-sm leading-[1.6] font-normal purple-gradient-text">
                    {item.title}
                  </span>
                </span>
              </div>
