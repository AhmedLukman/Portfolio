const SideNavHeader = () => {
  return (
    <header className="flex flex-col items-center justify-center gap-3">
      ...
      <span className="relative inline-flex overflow-hidden rounded-xl p-px focus:outline-hidden focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
