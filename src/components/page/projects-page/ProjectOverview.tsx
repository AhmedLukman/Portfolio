    ...
    <section className="flex flex-col lg:mt-10 lg:flex-row lg:gap-5 xl:mt-12 2xl:gap-10">
      ...
      <div className="flex basis-1/2 flex-col justify-between gap-10">
        ...
        <div className="flex animate-slide-in-from-bottom flex-col gap-3 opacity-0 animation-delay-1000">
          <h2 className="text-xl font-semibold">
            <span className="mr-2 purple-gradient">Metrics</span>
            <Tooltip
              showArrow
        ...
        <div className="mt-5 flex gap-5">
          <LinkPreview url={source} className="grow font-bold">
            <Button
              className="w-full animate-slide-in-from-left text-white opacity-0 animation-delay-2000 hover:text-black"
              variant="ghost"
          ...
          {isSitePortfolio && (
            ...
            >
              <Button
                className="grow animate-slide-in-from-right opacity-0 animation-delay-2000"
          ...
          {!isSitePortfolio && (
            <LinkPreview url={site} className="grow font-bold">
              <Button
                className="w-full animate-slide-in-from-right opacity-0 animation-delay-2000 hover:opacity-80!"
                endContent={<FontAwesomeIcon icon={faGlobe} />}
              >
                Explore site
              </Button>
